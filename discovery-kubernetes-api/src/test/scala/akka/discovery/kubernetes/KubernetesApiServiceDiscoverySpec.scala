...
class KubernetesApiServiceDiscoverySpec extends WordSpec with Matchers {
  "targets" should {
    "calculate the correct list of resolved targets" in {
      ...
      KubernetesApiServiceDiscovery.targets(podList, Some("akka-mgmt-http"), "default", "cluster.local") shouldBe List(
          ResolvedTarget(
    ...
    "ignore deleted pods" in {
      ...
      KubernetesApiServiceDiscovery.targets(podList, Some("akka-mgmt-http"), "default",
